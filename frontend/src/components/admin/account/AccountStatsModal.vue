    ...
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-sky-100 p-1.5 dark:bg-sky-900/30">
                <Icon name="clock" size="sm" class="text-sky-600 dark:text-sky-400" />
              </div>
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[var(--lx-clay-info-soft)] p-1.5">
                <Icon name="cube" size="sm" class="text-[var(--lx-clay-info)]" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
