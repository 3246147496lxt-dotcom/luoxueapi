      ...
      <Transition name="select-dropdown">
        ...
        >
          ...
          <div v-if="isSearchable" class="select-search">
            <Icon name="search" size="sm" class="text-[var(--lx-clay-text-muted)]" />
            <input
              ref="searchInputRef"
              v-model="searchQuery"
              type="text"
            ...
            >
              <slot name="option" :option="option" :selected="isSelected(option)">
                <Icon
                  ...
                  name="search"
                  size="sm"
                  class="flex-shrink-0 text-[var(--lx-clay-text-muted)]"
                />
                <span class="select-option-label" :class="option._creatable && 'italic text-[var(--lx-clay-text-secondary)]'">{{ getOptionLabel(option) }}</span>
                <Icon
...
.select-trigger-open {
  ...
  box-shadow: 0 0 0 2px color-mix(in srgb, var(--lx-clay-accent) 30%, transparent);
}
...
.select-dropdown-portal .select-option-group {
  ...
  color: var(--lx-clay-text-secondary);
  background: var(--lx-clay-surface-subtle);
}
