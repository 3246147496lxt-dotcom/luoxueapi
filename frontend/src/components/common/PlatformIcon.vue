<template>
  ...
  <svg v-else-if="platform === 'kimi'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M4 3h4v7l7-7h5l-7.5 7.5L21 21h-5l-6-7-2 2v5H4V3z"/>
  </svg>
  <!-- Zhipu GLM mark (constellation-inspired). -->
  <svg v-else-if="platform === 'zhipu'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    ...
    <circle cx="20.5" cy="12" r="1.2" />
    <circle cx="5.9" cy="5.9" r="1" />
    <circle cx="18.1" cy="5.9" r="1" />
    <circle cx="5.9" cy="18.1" r="1" />
    <circle cx="18.1" cy="18.1" r="1" />
    <path d="M12 5v4M12 15v4M5 12h4M15 12h4M7.2 7.2l2.1 2.1M14.7 14.7l2.1 2.1M16.8 7.2l-2.1 2.1M9.3 14.7l-2.1 2.1" stroke="currentColor" stroke-width="1.2" fill="none" stroke-linecap="round" />
  </svg>
  <!-- DeepSeek whale mark -->
  <svg v-else-if="platform === 'deepseek'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M21.8 6.2c-.8.5-1.5.7-2.2.6-.3-.8-.9-1.3-1.8-1.7-.4-.2-.7-.5-.8-.9-.1-.2-.2-.4-.4-.4-.3 0-.4.3-.5.6-.2.8 0 1.7.5 2.4-1.1-.9-2-2-3.2-2.7-1.4-.9-3-1.2-4.6-.9-2.4.4-4 2.1-4.5 4.5-.5 2.7.5 5.2 2.6 6.9 1.7 1.4 3.7 2 5.8 1.8 1.1-.1 2.4-.5 3.6-1.4.5.2 1 .3 1.6.3.5 0 .9-.1 1.3-.2.3-.1.3-.5 0-.7-.8-.3-1.2-.5-1.5-.8 1.3-1.5 2.1-3.3 2.4-5.5 0-.3.1-.6.1-.9.7-.1 1.3-.4 1.7-.8.5-.5.7-1.2.8-1.9.1-.3-.1-.5-.4-.3ZM10.6 16.9c-1.8-1.2-2.9-2.8-3.3-4.7-.2-1-.2-2 .1-2.8.1-.2.2-.3.5-.3 1.8.1 3.4.8 4.7 2.1.7.7 1.2 1.5 1.8 2.3.6.9 1.3 1.7 2.1 2.3-.9.8-2 .9-3 .8-1-.1-2-.1-2.9.3Z" />
  </svg>
