...
describe('ProfileInfoCard', () => {
  it('renders basic account information inside the new overview shell', () => {
    ...
    expect(wrapper.find('[data-testid="profile-auth-bindings-panel"]').exists()).toBe(true)
  })
  ...
  it('renders the approved overview hero and two-column content shell', () => {
    ...
    expect(wrapper.find('[data-testid="profile-overview-metric-balance"] [data-testid="snowflake-credit-icon"]').exists()).toBe(true)
    ...
    expect(wrapper.find('[data-testid="profile-main-column"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="profile-side-column"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="profile-basics-panel"]').exists()).toBe(true)
    expect(wrapper.find('[data-testid="profile-auth-bindings-panel"]').exists()).toBe(true)
  })
})
