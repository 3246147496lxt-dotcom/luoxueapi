<template>
  ...
  >
    <article v-if="!isSimple" class="dashboard-panel min-h-[205px] overflow-hidden">
      <DashboardCardHeader icon="creditCard" :title="t('dashboard.accountData')" />
    ...
    <article class="dashboard-panel min-h-[205px] overflow-hidden">
      <DashboardCardHeader icon="sync" :title="t('dashboard.usageStatistics')" />
      <div class="space-y-4 px-5 py-5">
        <DashboardMetricRow
          icon="trendingUp"
          tone="emerald"
    ...
    <article class="dashboard-panel min-h-[205px] overflow-hidden">
      <DashboardCardHeader icon="bolt" :title="t('dashboard.resourceUsage')" />
      <div class="space-y-4 px-5 py-5">
        <DashboardMetricRow
          icon="dollar"
          tone="amber"
    ...
    <article class="dashboard-panel min-h-[205px] overflow-hidden">
      <DashboardCardHeader icon="clock" :title="t('dashboard.performance')" />
      <div class="space-y-4 px-5 py-5">
        <DashboardMetricRow
          icon="clock"
          tone="indigo"
...
const DashboardCardHeader = defineComponent({
  ...
  setup(props) {
    return () => h('div', {
      ...
      h(Icon, { name: props.icon, size: 'sm', strokeWidth: 1.8 }),
      h('span', props.title),
    ])
  },
})
