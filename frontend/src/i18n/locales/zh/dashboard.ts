export default {
  dashboard: {
    ...
    analysisTotalCost: '区间实际消费 ${value}',
    creditUnit: '$',
  ...
  keys: {
    ...
    workspacePointsUnit: '$',
    workspaceSheetCurrentAvailable: '当前可用美元',
  ...
  redeem: {
    ...
    balanceRedeemSummary: '已添加 {added} $，当前余额 {balance} $。',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      enabled: '启用余额不足提醒',
      threshold: '自定义提醒阈值（$）',
      thresholdHint: '留空使用系统默认的$值',
      thresholdPlaceholder: '输入$',
      systemDefault: '系统默认值',
      extraEmails: '通知邮箱',
