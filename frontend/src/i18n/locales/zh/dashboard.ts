export default {
  dashboard: {
    ...
    workspace: {
      ...
      token: 'Token',
      cachedInput: '输入（缓存）',
      uncachedInput: '输入（未缓存）',
      outputTokens: '输出',
      noUsageData: '暂无使用记录',
      notifications: '通知',
      systemAnnouncement: '系统公告',
      collapseNotifications: '收起',
      balance: '可用余额',
      ...
      managePlan: '管理套餐',
      modelUsage: '模型使用情况',
      insightsSection: 'Dashboard 分析模块',
      modelRanking: '模型使用排行',
      usageShare: '使用占比',
      modelRankingLoadError: '模型排行暂时无法加载，正在保留上一次数据。',
      channelStatus: '渠道状态',
      last24Hours: '近24小时',
      channelSelector: '选择渠道',
      noChannels: '暂无渠道',
      channelLoadError: '渠道状态暂时无法加载。',
      viewDetails: '查看详情',
    ...
    analysisTotalCost: '区间实际消费 {value} 积分',
    creditUnit: '积分',
  ...
  keys: {
    ...
    endpoints: {
      ...
      testing: '测速中…',
      connected: '已连接',
      connectedWithLatency: '已连接 · {latency} ms',
      retry: '重新测速',
      failed: '连接失败',
    },
    allGroups: '全部分组',
    ...
    createKey: '创建密钥',
    gptFastMode: 'GPT极速模式',
    gptFastModeHint: '优先使用低延迟线路',
    gptFastModeEnabled: 'GPT极速模式已开启',
    gptFastModeDisabled: 'GPT极速模式已关闭',
    editKey: '编辑密钥',
    deleteKey: '删除密钥',
    ...
    workspaceSheetCurrentAvailable: '当前可用积分',
    ...
    enable: '启用',
    disable: '禁用',
    serviceTierPreferenceLabel: '极速模式（Fast）',
    serviceTierPriority: 'Priority',
    serviceTierStandard: 'Standard',
    serviceTierPreferenceHint: '仅对 GPT-5.6 Sol 生效；只有已验证支持的上游才发送 Priority，否则按 Standard。',
    serviceTierEnableTitle: '确认开启极速模式',
    serviceTierEnableConfirmMessage: '极速模式只对 GPT-5.6 Sol 生效，且仅在上游已验证支持 Priority 时发送 Priority。未验证或不支持时会自动按 Standard 处理；Priority 用量和费用更高。',
    serviceTierEnableConfirm: '确认开启',
    serviceTierEnabledSuccess: '极速模式已开启',
    serviceTierDisabledSuccess: '极速模式已关闭',
    serviceTierUpdateFailed: '更新极速模式失败，已保留原设置',
    nameLabel: '名称',
  ...
  redeem: {
    ...
    balanceRedeemSummary: '已添加 {added} 积分，当前余额 {balance} 积分。',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      enabled: '启用余额不足提醒',
      threshold: '自定义提醒阈值（积分）',
      thresholdHint: '留空使用系统默认的积分值',
      thresholdPlaceholder: '输入积分',
      systemDefault: '系统默认值',
      extraEmails: '通知邮箱',
