export default {
    ops: {
      ...
      sidebar: {
        avatar: '管',
        admin: '管理员',
        balanceSubscription: '余额与订阅状态',
        adminWorkspace: '管理后台',
        personalWorkspace: '个人中心',
        switchToPersonalWorkspace: '切换到个人中心',
        dashboard: '管理仪表盘',
        usage: '用量明细',
        backHome: '返回首页',
        sections: {
      ...
      trafficRail: {
        ...
        coreSignals: '核心观测信号',
        healthScore: '系统健康度',
        healthBasis: '基于 SLA 与错误率分析',
        slaAttainment: 'SLA 达成率',
        requestErrorRate: '请求错误率',
        realtimeThroughput: '实时吞吐',
        concurrencyQueue: '并发 / 排队',
        excludedBusinessLimits: '已排除 429/529',
        queueDepth: '当前排队深度为 {count}',
        baseHealth: '系统基础健康'
      },
      workspace: {
        label: '监控分类',
      ...
      trafficSectionTitle: '吞吐趋势',
      trafficSectionDescription: '排除业务限制后的系统请求成功比例与异常趋势分析。',
      trafficSectionStatus: '实时链路正常',
      incidentsSectionTitle: '异常告警',
      incidentsSectionDescription: '按影响优先级检查请求错误与上游异常。',
      incidentsSectionStatus: '异常优先模式',
      ...
      systemLogs: {
        ...
        runtimeConfigHint: '日志级别、调用方、堆栈和采样设置保存后立即生效。',
        retentionClarification: 'retention_days 为兼容配置字段；系统日志定时清理由数据保留策略执行，不随日志级别即时切换。',
        all: '全部',
        level: '级别',
        ...
        logManagement: '日志管理',
        clearAlertContext: '清除告警联动条件',
        cleanCurrentFilters: '清理当前筛选结果',
        cleanupDangerHint: '仅清理当前筛选命中的日志，提交前会再次确认。此操作不可撤销。',
        refreshHealth: '刷新健康状态',
        empty: '暂无系统日志',
        emptyHint: '请调整上方筛选条件后重新搜索。',
        time: '时间',
        message: '消息',
        requestSummary: '请求摘要',
        ...
        perPage: '条 / 页',
        logDetails: '日志详情',
        inspectorTitle: '日志属性详情',
        closeDetails: '关闭日志详情',
        inspectorHint: '选择日志后查看完整结构化上下文。',
        noSelection: '选择左侧表格中的日志条目',
        noSelectionHint: '查看完整的结构化日志详情与上下文标识',
        investigationFromAlert: '来自告警事件',
        contextOnly: '仅上下文',
        appliedFilters: '已应用筛选',
        frequentFilters: '高频过滤器',
        relatedIdentifiers: '关联标识',
        requestContext: '业务链路',
        errorDetails: '异常详情',
        rawExtra: '原始 extra JSON',
        sinkHealth: '日志汇聚健康',
        healthHealthy: '正常',
        healthWarning: '有丢弃',
        healthUnhealthy: '异常',
        healthUnavailable: '未获取健康数据',
        healthLoaded: '已获取',
        avgWriteDelay: '平均写入延迟',
        results: '查询结果',
        newestFirstCount: '{count} 条 · 最新优先',
        loadFailed: '加载系统日志失败',
      ...
      alertEvents: {
        ...
        filterLabel: '筛选范围',
        refreshQueue: '刷新列表',
        emptyHint: '当前筛选条件下没有匹配的记录',
        disabledTitle: '告警事件展示已关闭',
        disabledHint: '可在监控设置中重新开启展示',
        globalContext: '当前筛选范围证据 (GLOBAL CONTEXT)',
        filterTime: '时间',
        filterEmail: '邮件',
        loading: '加载中...',
        loadMore: '加载更多',
        ...
        detail: {
          title: '告警详情',
          emptyTitle: '从左侧列表选择一个告警事件以开始核查',
          emptyHint: '选择告警后，系统将自动提取触发时间窗口与相关维度信息供您深入排障。',
          emptyTip: '提示：查看相关日志时可带入平台与时间窗；request_id 仅在事件包含时传递。',
          open: '查看告警详情：{title}',
          loading: '加载详情中...',
          empty: '暂无详情',
          loadFailed: '加载告警详情失败',
          ...
          historySectionTitle: '历史事件记录',
          historySectionHint: '同一规则 + 相同维度的最近事件汇总。',
      ...
      charts: {
        throughputSubtitle: '正在分析当前选定时间窗口内的 QPS 与 Token/TPS 变化轨迹',
        trendView: '趋势视图',
        distributionView: '分布视图',
        tokenStatsView: 'Token 统计',
        viewMode: '吞吐视图',
        currentAverage: '当前平均',
        observedPeak: '观测峰值',
        tokenLoad: 'Token 负载 (TPS)',
        noWindowBaseline: '暂无窗口基线',
        peakVsWindowAverage: '+{percent}% vs 窗口均值',
        windowTokenTotal: '窗口内累计处理 {count} Tokens',
        periodLegend: '周期图例',
        currentPeriod: '当前周期',
        comparisonPeriod: '对比周期',
        throughputEmptyTitle: '吞吐趋势数据渲染区',
        viewRequestDetails: '查看请求明细',
        exportData: '导出数据',
        exportDataHint: '导出当前吞吐数据',
        viewDetails: '查看明细',
        downloadChartFull: '下载图表',
