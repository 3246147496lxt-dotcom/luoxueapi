export default {
    accounts: {
      title: '账号池',
      description: '管理上游账号、调度状态与容量',
      workbench: {
        identity: '账号身份',
        quotaCapacity: '额度/容量摘要',
        quotaUsed: '已用 {percent}%',
        quotaUnavailable: '暂无额度',
        quotaLabel: '配额',
        totalQuotaLabel: '总额',
        concurrencySummary: '并发 {current} / {max}',
        quotaOverview: '额度概览',
        fiveHourRollingWindow: '5h 滑动窗口',
        sevenDayTotalQuota: '7d 总配额',
        twentyFourHourQuota: '24h 配额',
        dailyQuota: '每日配额',
        totalQuota: '总配额',
        requestQuota: '请求配额',
        tokenQuota: 'Token 配额',
        modelQuota: '{model} 配额',
        quotaResetCountdown: '将在 {time} 后开始重置',
        quotaResetPending: '额度窗口待刷新',
        quotaResetNow: '额度窗口即将重置',
        quotaResetsAt: '预计 {date} 重置 · 剩余 {time}',
        quotaResetPendingAt: '计划于 {date} 重置 · 等待额度刷新',
        membershipCycle: 'ChatGPT 会员',
        workspaceEntitlement: '工作区权益',
        membershipCurrentPeriodUntil: '当前周期至 {date}',
        membershipExpiresAt: '将于 {date} 到期',
        membershipExpiredAt: '已于 {date} 到期',
        membershipRefreshNeeded: '会员信息待刷新',
        membershipLastRecordedUntil: '上次记录至 {date}',
        membershipUnavailable: '未查询到会员日期',
        membershipQueryHint: '点击“查询额度”同步会员周期',
        membershipNotReturned: '上游未返回有效的会员周期',
        membershipAutoRenewOn: '已开启自动续费',
        membershipAutoRenewOff: '到期后不续费',
        membershipRenewUnknown: '续费状态未知',
        workspaceEntitlementUntil: '权益有效至 {date}',
        workspaceEntitlementHint: '以工作区权限与账单设置为准',
        localConcurrencyCapacity: '本地并发容量',
        concurrencySlots: '{current} / {max} 槽位',
        activeStatus: '活跃',
        fullStatus: '满载',
        statusScheduling: '状态与调度',
        effectiveGroups: '生效分组',
        recentActivity: '最近活动',
        scheduling: '参与调度',
        groupsAndProxy: '分组与代理',
        routeAndExit: '路由与出口',
        proxyName: '代理名称',
        proxyEndpoint: '代理端点',
        countryCode: '国家 / 地区',
        ...
        exitIp: '出口 IP',
        proxyRoute: '经代理出口',
        directRoute: '未配置代理，当前为直连',
        viewProxyInManagement: '在 IP 管理中查看代理 {name}',
        proxyStatus: {
          active: '正常',
          inactive: '停用',
          expired: '已过期'
        ...
        policies: '策略与补充信息',
        notes: '备注',
        accountExpiresAt: '账号到期',
        priority: '调度优先级',
        billingRate: '计费倍率',
        fiveHourReset: '5 小时窗口重置',
        sevenDayReset: '7 天窗口重置',
        dailyReset: '每日配额重置',
        weeklyReset: '每周配额重置',
        sessionWindowEnd: '会话窗口结束',
        windowCostPolicy: '窗口费用 / 粘性预留',
        sessionPolicy: '会话上限 / 空闲分钟',
        rpmPolicy: 'RPM / 策略',
        ...
        accountUserCost: '账号 / 用户成本',
        recovery: '状态与恢复',
        errorReason: '错误原因',
        rateLimitReset: '限流恢复',
        overloadUntil: '过载恢复',
        tempUnschedulableUntil: '临时停调恢复',
        modelRateLimits: '模型级限流',
        modelRateLimitCount: '{count} 个模型等待恢复',
        closeDetails: '关闭账号详情',
        viewStats: '查看统计',
        selectAccount: '选择一个账号，查看额度、今日使用、异常恢复、策略、分组和代理信息。',
        inspectAccount: '查看账号 {name} 的详情',
        selectAccountCheckbox: '选择账号 {name}'
      },
      createAccount: '添加账号',
      autoRefresh: '自动刷新',
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非落雪API配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在落雪API端解除该限制。',
      upstreamBilling: {
        trustWarning: '此倍率由上游站点针对当前 API Key 自行声明。落雪API无法验证该值是否与实际扣费一致；上游站点或中间代理可能返回伪造、过期或被篡改的数据。请结合账单、余额变化和实际用量自行核验。',
      ...
      status: {
        ...
        quotaExceeded: '额度耗尽',
        quotaExceededUntil: '额度耗尽，预计 {time} 恢复',
        unschedulable: '不可调度',
        ...
        tempUnschedulableUntil: '临时停调至 {time}',
      ...
      usageWindow: {
        ...
        grokRequests: '请求',
        grokTokens: 'Token',
        grokFreeQuota24hHint: '按落雪API近 24 小时本地 Token 用量估算（上限 2M）',
      ...
      openaiQuotaReset: {
        ...
        resetTooltipNeedQuery: '先点击「重置次数」加载剩余重置次数',
      ...
      openai: {
        ...
        endpointCapabilitiesDesc:
          '用于调度筛选。文本端点跟随上方 Responses API 支持；Embeddings 独立控制 /v1/embeddings。语音转写仅将该账号加入受控 STT 资源池，用于 /v1/audio/transcriptions。',
        ...
        capabilityAudioTranscriptions: '语音转写',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个落雪API实例的场景。',
      ...
      copilot: {
        ...
        title: '账号池助手',
        pageTitle: '账号池运维助手',
        pageDescription: '把账号池交给 AI：扫描、测试、筛出过期或鉴权失败的账号，再由你确认删除；也可以把 API Key 交给本服务添加，凭证不会发给模型。',
        subtitle: '用自然语言把活交给助手。它会用当前管理员会话干活。添加和删除都要你在右侧确认；凭证只留在本服务，不会发给模型。',
        chatTitle: '对话',
        you: '你',
        assistant: '助手',
        selectAll: '全选',
        selectNone: '取消全选',
        welcome: '直接跟我说要扫描、测试或筛选哪些账号；也可以把 API Key 或 JSON 贴过来交给本服务添加。凭证不会发给模型。添加和删除都要你在右侧勾选确认。',
        scan: '全量健康检查',
        test: '测试并筛选',
        deleteSelected: '删除所选',
        addSelected: '添加所选',
        inputPlaceholder: '告诉我要扫描的账号，或直接粘贴 API Key / JSON',
        send: '发送',
        emptyQueue: '还没有待确认的账号。先在对话里让我扫描或测试。',
        emptyAddQueue: '还没有待添加的账号。把 API Key 或 JSON 贴到对话里，会出现在这里。',
        reviewTitle: '待你确认',
        tabCleanup: '待清理',
        tabAdd: '待添加',
        ...
        queueImporting: '导入中',
        queueFailed: '导入失败',
        queueQuarantined: '已隔离',
        advancedSettings: '高级设置',
        scanFrequency: '自动检查频率',
        frequencyDaily: '每天（推荐）',
        frequencyWeekly: '每周',
        frequencyManual: '仅手动',
        failurePolicy: '失效账号处理',
        policyQuarantine: '自动隔离（推荐）',
        policyReview: '留在待确认',
        enableNotifications: '启用重要事件站内提醒',
        enableEmailNotifications: '启用邮件提醒',
        enableWebhookNotifications: '启用 Webhook 提醒',
        webhookUrl: 'Webhook 地址',
        webhookUrlPlaceholder: 'https://example.com/hooks/account-health',
        settingsHint: '代理与分组建议会根据平台和当前可用节点自动生成。更细的路由规则可在账号池设置中调整。',
        enableRegisterWatcher: '监听注册机输出目录',
        registerOutputDir: '注册机输出目录',
        registerOutputDirPlaceholder: '/path/to/grok-register/tokens',
        registerAutoDiscover: '发现新文件后提示导入',
        registerScan: '扫描注册机文件',
        registerScanning: '正在扫描…',
        registerLastScan: '上次扫描：{time}',
        registerFound: '发现 {count} 个新的 Grok SSO 文件，已加入待添加队列。',
        registerNone: '没有发现新的注册机 SSO 文件。',
        registerScanFailed: '扫描注册机输出目录失败，请检查目录配置。',
        retryFailed: '重试失败项（{count}）',
        confirmTitle: '确认删除账号',
        confirmMessage: '将删除 {count} 个你勾选的账号。此操作不可撤销，请再次确认。',
        confirmAddTitle: '确认添加账号',
        confirmAddMessage: '将把 {count} 个勾选的 API Key 写入账号池。凭证只留在本服务，不会发给模型。',
        ssoConfirmAddMessage: '将把 {count} 个 Grok SSO Token 转换并导入账号池，使用你选择的代理和分组。Token 不会发送给模型。',
        handoffSubmitted: '已提交待添加的账号凭证（不会发给模型）。',
        ssoDetected: '检测到 Grok SSO Token。请选择代理节点和分组，然后在右侧勾选并确认导入。Token 不会发送给模型。',
        ssoOptionsTitle: 'Grok SSO 导入选项',
        proxyLabel: '代理节点',
        proxyDirect: '直连（不使用代理）',
        groupsLabel: '分组（可多选）',
        groupsEmpty: '暂无可用的 Grok 分组',
        addHint: '粘贴 Key 或 JSON 后出现在右侧，勾选确认才写入；凭证只留在本服务，不发给模型。',
        scanning: '正在扫描账号池…',
        testing: '正在测试账号可用性…',
        thinking: '助手正在思考并调用工具…',
        deleting: '正在删除…',
        error: '助手请求失败',
        needWorkingKey: '需要至少一个可用的 OpenAI 兼容 API Key 账号，助手才能工作。',
        noCleanup: '没有需要清理的账号。',
        deleted: '已删除 {count} 个账号。',
        failed: '{count} 个账号删除失败。',
        added: '已添加 {count} 个账号。',
        addFailed: '{count} 个账号添加失败。',
        backToAccounts: '返回账号池',
        tools: {
          scan_account_pool: '扫描账号池',
          test_account_pool: '测试账号池'
        },
        suggestions: {
          scan: '全量实时检查账号池',
          test: '测试异常账号并筛出不可用的',
          add: '把 API Key 交给我添加到账号池',
          help: '这个助手能做什么？'
        },
        reasons: {
          auth_failed: '鉴权失败 / Token 不可用',
          expired: '已过期',
          rate_limited: '限流中',
          quota_exhausted: '额度用尽',
          overloaded: '上游过载',
          temp_unschedulable: '暂时不可调度',
          error_unknown: '异常（原因不明）',
          healthy: '正常',
          inactive: '已停用'
        }
      }
