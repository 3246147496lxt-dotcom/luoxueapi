export default {
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 CNY 可获得多少美元',
        balanceRechargePreview: '预览：¥1 = ${credit}',
      ...
      balanceNotify: {
        ...
        enabled: '启用余额不足提醒',
        threshold: '默认提醒阈值（$）',
        thresholdHint: '用户未自定义时使用此美元值',
        thresholdPlaceholder: '输入美元金额',
