export default {
    ...
    usage: {
      title: '用量审计台账',
      description: '全站请求追踪、成本核算与故障排查工作台',
      workspace: {
        tabsLabel: '用量分析视图',
        scopeLabel: '当前分析范围',
        summaryLabel: '当前范围汇总',
        filtersLabel: '审计筛选条件',
        evidenceLabel: '审计证据与分析',
        periodTitle: '审计周期与粒度',
        auditObjectsTitle: '核心审计对象',
        conditionsTitle: '生效条件',
        noActiveFilters: '暂无已应用的筛选条件',
        activeFilters: '已应用 {count} 个筛选条件',
        applyFilters: '应用当前筛选',
        resetLedger: '重置台账',
        dangerTitle: '危险操作',
        densityLabel: '表格密度',
        ...
        columns: {
          auditSubject: '审计主体',
          modelMapping: '模型映射 (入/出)',
          tokenPayload: 'Token 负载',
          actualCharge: '实际扣费',
          latencyResponse: '延迟响应',
          channelAccount: '渠道账户',
          timeSerial: '时间/序列号',
          ipGeo: 'IP 地理',
        },
        ...
        analyticsTitle: '数据分析概览',
        analyticsDescription: '在逐条记录之外，对照模型、分组、端点和时间趋势识别结构变化。',
        tabs: {
          usageDescription: '逐条核对请求、Token、费用与延迟。',
          usageDetail: '筛选后查看每次调用的用户身份、模型路径、计费和性能证据。',
          errorsDescription: '从失败事件定位阶段、分类和影响对象。',
          errorsDetail: '只读审计失败请求；展开记录可复制请求标识并核对原始响应。',
          rankingDescription: '比较当前范围内各用户的请求与消耗。',
          rankingDetail: '用户名存在时优先显示，同时保留邮箱与用户 ID 作为可核对身份。',
          billingDescription: '核对 GPT 聊天产生的只读结算凭证。',
          billingDetail: '逐条检查账单 ID、请求 ID、Token、扣费、余额变化和失败原因。',
        },
      },
      userFilter: '用户',
      clearUserFilter: '清除用户筛选',
      clearApiKeyFilter: '清除 API 密钥筛选',
      ...
      billingReceipts: {
        title: '聊天账单',
        subtitle: '按请求保留 Web Chat 结算证据，便于追溯每一笔账单。',
        readOnly: '只读审计账本',
        readOnlyDescription: '可在此核对标识与计费事实，但不能修改账单或余额。',
        loadFailed: '加载聊天账单失败',
        empty: '暂无聊天账单',
        emptyDescription: '当前时间范围和筛选条件下没有匹配的聊天请求。',
        viewDetails: '查看只读详情',
        openDetails: '打开审计记录 {id} 的只读详情',
        sourceWebChat: 'Web Chat',
        copyReceiptId: '复制账单 ID',
        ...
        filters: {
          ...
          receiptId: '账单 ID',
          receiptIdPlaceholder: '输入完整账单或请求 ID',
          status: '状态',
        },
        statuses: {
          all: '全部状态',
        ...
        drawer: {
          title: '聊天计费详情',
          subtitle: '不可变的请求结算快照',
          readOnlyNote: '这是只读审计记录，不提供退款、重算、重试或其他计费写操作。',
          sections: {
            identifiers: '审计标识',
            models: '模型路由',
            tokens: 'Token 明细',
