export default {
  dashboard: {
    ...
    workspace: {
      ...
      cumulativeSpend: 'Cumulative credits used',
      creditsUnit: 'credits',
      tokenUnit: 'Token',
      ...
      creditsTrend: 'Credit usage trend',
      ...
      actions: {
        ...
        balance: 'Balance',
        balanceDescription: 'View credits and top up',
        apiKeys: 'API keys',
  ...
  keys: {
    ...
    workspaceSheetCurrentAvailable: 'Available Snow Credits',
    ...
    workspaceRateHeading: 'Rate Limits (Snow credits)',
    ...
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (Snow credits)',
    rateLimit1d: 'Daily Limit (Snow credits)',
    rateLimit7d: '7-Day Limit (Snow credits)',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      threshold: 'Custom Threshold (Snow credits)',
      thresholdHint: 'Leave empty to use the system default Snow-credit value',
      thresholdPlaceholder: 'Enter Snow credits',
