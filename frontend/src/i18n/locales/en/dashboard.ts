export default {
  dashboard: {
    ...
    workspace: {
      ...
      cumulativeSpend: 'Cumulative USD used',
      creditsUnit: '$',
      tokenUnit: 'Token',
      ...
      creditsTrend: 'USD usage trend',
      creditsUsed: 'USD used',
      token: 'Token',
      ...
      actions: {
        ...
        balance: 'Balance',
        balanceDescription: 'View $ and top up',
        apiKeys: 'API keys',
    ...
    analysisTotalCost: '${value} spent in range',
    creditUnit: '$',
  ...
  keys: {
    ...
    workspacePointsUnit: '$',
    workspaceSheetCurrentAvailable: 'Available USD',
    ...
    workspaceRateHeading: 'Rate Limits ($)',
    ...
    quotaAmountPlaceholder: 'Enter a $ limit',
  ...
  affiliate: {
    ...
    transfer: {
      ...
      success: '{amount} $ have been transferred to your balance'
    },
    invitees: {
      title: 'Invited Users',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      thresholdHint: 'Leave empty to use the system default $ value',
      thresholdPlaceholder: 'Enter $',
