export default {
  dashboard: {
    ...
    overviewTitle: 'API usage dashboard',
    overviewDescription: 'Manage keys, monitor live spend, and quickly review your latest API calls.',
    greeting: {
    ...
    filterEnd: 'End date',
    filterGranularity: 'Time granularity',
    loadErrorTitle: 'The dashboard could not be loaded',
    loadErrorDescription: 'Check your connection and try again. Your account and usage data are unaffected.',
    retry: 'Reload',
    footer: 'Secure, reliable API service',
    accountMetrics: 'Account and usage overview',
    workspace: {
      greeting: '{period}, {name}',
      welcomeDescription: 'Your AI workspace at a glance, with balance, usage, and recent activity in one place.',
      accountBalance: 'Account balance',
      planQuota: '{plan} quota',
      remaining: 'remaining',
      cumulativeTokens: 'Cumulative tokens',
      cumulativeSpend: 'Cumulative points used',
      creditsUnit: 'Points',
      tokenUnit: 'Token',
      ...
      creditsTrend: 'Points usage trend',
      creditsUsed: 'Points used',
      token: 'Token',
      cachedInput: 'Input (cached)',
      uncachedInput: 'Input (uncached)',
      outputTokens: 'Output',
      noUsageData: 'No usage records yet',
      notifications: 'Notifications',
      systemAnnouncement: 'System announcement',
      collapseNotifications: 'Collapse',
      balance: 'Available balance',
      balanceHint: 'Used for metered API calls and model usage',
      manageBalance: 'Manage balance',
      todayUsage: "Today's usage",
      todayRequestsHint: '{count} requests today',
      viewUsage: 'View usage',
      tokenConsumption: 'Token consumption',
      tokenBreakdownHint: '{input} input · {output} output',
      currentPlan: 'Current plan',
      planLoading: 'Loading plan information',
      payAsYouGo: 'Pay as you go',
      planExpires: 'Valid until {date}',
      planNoExpiry: 'Your current plan has no expiry',
      planFlexible: 'Use on demand and manage anytime',
      managePlan: 'Manage plan',
      modelUsage: 'Model usage',
      insightsSection: 'Dashboard insight modules',
      modelRanking: 'Model usage ranking',
      usageShare: 'Usage share',
      modelRankingLoadError: 'Model ranking is temporarily unavailable; the last data is retained.',
      channelStatus: 'Channel status',
      last24Hours: 'Last 24 hours',
      channelSelector: 'Select channel',
      noChannels: 'No channels',
      channelLoadError: 'Channel status is temporarily unavailable.',
      viewDetails: 'View details',
      selectedRange: '{start} to {end}',
      rangeSummary: 'Usage summary for the selected range',
      requests: 'Requests',
      requestCount: 'Requests',
      tokens: 'Tokens',
      spend: 'Points used',
      model: 'Model',
      loadingModels: 'Loading model usage',
      noModelUsage: 'No model usage in the selected range yet',
      exploreModels: 'Explore model center',
      viewAll: 'View all',
      ...
      actions: {
        ...
        newChatDescription: 'Start an AI session',
        models: 'Model center',
        modelsDescription: 'Browse available models',
        balance: 'Balance',
        balanceDescription: 'View points and top up',
        apiKeys: 'API keys',
        apiKeysDescription: 'Manage access credentials',
        usage: 'Usage records',
        usageDescription: 'Review API activity',
      },
      apiInfoDescription: 'Service endpoints for SDK and client integrations',
      manageApiKeys: 'Manage keys',
      primaryEndpoint: 'Default',
      customEndpoint: 'Custom',
      copyEndpoint: 'Copy {name}',
      copy: 'Copy',
      copied: 'Copied',
      accountInfo: 'Account information',
      accountInfoDescription: 'Current sign-in and access status',
      ...
      apiKeys: 'API keys',
      activeApiKeys: '{active} active of {total}',
    ...
    rangeSpend: 'Range spend',
    rangeTokens: 'Range tokens',
    averageRpm: 'Average RPM',
    averageTpm: 'Average TPM',
    modelAnalysis: 'Model data analysis',
    analysisTabs: {
      label: 'Data analysis views',
      usageCalendar: 'Usage calendar',
      costDistribution: 'Cost distribution',
      costTrend: 'Cost trend',
      requestDistribution: 'Request distribution',
      requestRanking: 'Request ranking',
      costDistributionTitle: 'Model cost distribution',
      costTrendTitle: 'Cost trend',
      requestDistributionTitle: 'Model request distribution',
      requestRankingTitle: 'Model request ranking'
    },
    calendarSummary: '{days} active days · {requests} requests',
    calendarRequests: '{count} requests',
    analysisTotalCost: '{value} Points spent in range',
    creditUnit: 'Points',
    analysisTotalRequests: '{value} requests in range',
    actualCost: 'Actual cost',
    apiInfo: {
      title: 'API information',
      primary: 'Primary API URL',
      primaryDescription: 'Recommended default service endpoint',
      custom: 'Custom endpoint',
      speedTest: 'Speed test',
      speedTestEndpoint: 'Test access speed for {name}',
      open: 'Open',
      openEndpoint: 'Open {name}',
      empty: 'No API endpoints are configured'
    },
    announcements: {
      title: 'System announcements',
      latest: 'Latest {count}',
      empty: 'No system announcements'
    },
    faq: {
    ...
    availability: {
      ...
      search: 'Search models or channels',
      empty: 'No matching service status',
      disabled: 'Service monitoring is disabled',
      failed: 'Failed',
  ...
  keys: {
    ...
    cardDescription: 'API keys authenticate API access and can be limited by quota, group, and usage rules.',
    workspaceSubtitle: 'Manage authentication tokens and quota rules',
    ...
    detailSettings: 'Detail Display Settings',
    detailTitle: 'Key Detail Configuration',
    viewDetailsAndActions: 'View Details and Actions',
    columnAlwaysVisible: 'This column is always visible',
    showActions: 'Show Actions',
    hideActions: 'Hide Actions',
    compactList: 'Compact Density',
    comfortableList: 'Comfortable Density',
    sortCreatedDesc: 'Sort: Newest Created',
    sortCreatedAsc: 'Sort: Oldest Created',
    sortIdDesc: 'ID: Highest First',
    sortIdAsc: 'ID: Lowest First',
    sortNameAsc: 'Name: A–Z',
    sortNameDesc: 'Name: Z–A',
    sortStatusAsc: 'Status: Ascending',
    sortStatusDesc: 'Status: Descending',
    sortExpirationAsc: 'Expiration: Earliest',
    sortExpirationDesc: 'Expiration: Latest',
    sortLastUsedDesc: 'Last Used: Newest',
    sortLastUsedAsc: 'Last Used: Oldest',
    sortConcurrencyDesc: 'Concurrency: Highest',
    sortConcurrencyAsc: 'Concurrency: Lowest',
    createKey: 'Create API Key',
    gptFastMode: 'GPT Fast mode',
    gptFastModeHint: 'Prefer lower-latency routes',
    gptFastModeEnabled: 'GPT Fast mode enabled',
    gptFastModeDisabled: 'GPT Fast mode disabled',
    ...
    apiKey: 'API Key',
    key: 'Key',
    workspaceKeyInfo: 'Key Information',
    workspaceAssignedGroup: 'Assigned Group',
    workspaceUnassignedGroup: 'Unassigned Group',
    workspaceAvailableQuota: 'Available Quota',
    workspacePageOf: 'Page {page} of {total}',
    workspaceTokenLabel: 'API Key Token',
    workspaceEndpointLabel: 'API Endpoint',
    workspaceEndpointEmpty: 'Provided by system settings and hidden when not configured',
    workspaceQuotaHeading: 'Quota Progress',
    workspaceQuotaProgress: 'Quota Usage Progress',
    workspaceSheetQuotaHeading: 'Quota and Usage Overview',
    workspaceCurrentAvailable: 'Currently Available',
    workspaceTotalLimit: 'Total Limit',
    workspacePointsUnit: 'Points',
    workspaceSheetCurrentAvailable: 'Available Points',
    workspaceSheetTotalLimit: 'Total Usage Limit',
    workspaceTodayUsage: 'Today Total',
    workspaceThirtyDayUsage: 'Last 30 Days Total',
    workspaceCardTodayUsage: 'Today Billing Total',
    workspaceCardThirtyDayUsage: '30-Day Billing Total',
    workspaceThirtyDayShort: '30D',
    workspaceSheetTodayUsage: 'Today Billing',
    workspaceSheetThirtyDayUsage: 'Last 30 Days Billing',
    workspaceResetQuota: 'Reset Used Quota',
    workspaceRateHeading: 'Rate Limits (Points)',
    workspaceSheetRateHeading: 'Rate Limits and Windows',
    workspaceResetAll: 'Reset All',
    workspaceResetWindow: 'Reset Window',
    workspaceResetInInline: 'RESET IN: {time}',
    workspaceResetInSheet: 'Resets in {time}',
    workspaceSecurityHeading: 'Security Controls and History',
    workspaceSheetSecurityHeading: 'Security and History Audit',
    workspaceCoreAuthHeading: 'Core Status and Authentication',
    ...
    workspaceSheetTokenLabel: 'Key Token (API KEY TOKEN)',
    workspaceSheetEndpointLabel: 'Endpoint (API ENDPOINT)',
    workspaceConcurrencyLimit: 'Concurrency Limit',
    workspaceSheetConcurrencyLimit: 'Concurrency Window Limit',
    workspaceSheetExpiration: 'Expiration Date',
    workspaceIpConfigured: '{count} items configured',
    workspaceCreatedInline: 'Created on',
    workspaceLastUsedInline: 'Last used',
    workspaceLastIpInline: 'Recent IP',
    workspaceCreatedSheet: 'Creation time',
    workspaceLastUsedSheet: 'Previous use',
    workspaceLastIpSheet: 'Last IP',
    workspaceRate5hInline: '5h Limit (5-hour window)',
    workspaceRate1dInline: '1d Limit (daily)',
    workspaceRate7dInline: '7d Limit (weekly)',
    workspaceRate5hSheet: '5-hour Limit',
    workspaceRate1dSheet: 'Daily Limit (24H)',
    workspaceRate7dSheet: '7-day Limit (168H)',
    workspaceImportCcs: 'Import CCS',
    group: 'Group',
    ...
    hideKey: 'Hide full key',
    importToCcSwitch: 'Import to CCS',
    enable: 'Enable',
    disable: 'Disable',
    serviceTierPreferenceLabel: 'Fast mode (Priority)',
    serviceTierPriority: 'Priority',
    serviceTierStandard: 'Standard',
    serviceTierPreferenceHint: 'Applies only to GPT-5.6 Sol; Priority is sent only to verified-capable upstreams, otherwise Standard is used.',
    serviceTierEnableTitle: 'Enable Fast mode?',
    serviceTierEnableConfirmMessage: 'Fast mode applies only to GPT-5.6 Sol and sends Priority only when the upstream has verified support. Unknown or unsupported upstreams automatically use Standard; Priority uses more quota and costs more.',
    serviceTierEnableConfirm: 'Enable Fast mode',
    serviceTierEnabledSuccess: 'Fast mode enabled',
    serviceTierDisabledSuccess: 'Fast mode disabled',
    serviceTierUpdateFailed: 'Could not update Fast mode; the previous setting was kept',
    nameLabel: 'Name',
    ...
    quotaUsage: 'API key quota usage',
    noIpRestriction: 'No restrictions',
    whitelistCount: 'Allowlist {count}',
    blacklistCount: 'Blocklist {count}',
    noRateLimit: 'Not set',
    ...
    useKeyModal: {
      ...
      openai: {
        description: 'Add the following configuration files to the Codex config directory. API Key Mode writes the Bearer credential into the provider configuration and enables the client-side image executor.',
        authModeTitle: 'Codex authentication mode',
        authModeDescription: 'Compatibility mode reads the key from auth.json. API Key Mode writes the Bearer credential into the selected provider configuration and preserves the client-side image-executor marker.',
        ...
        note: 'Make sure the config directory exists. API Key Mode stores the key in config.toml; do not commit or share this file. Fully quit and restart the Codex client after changes. macOS/Linux users can run mkdir -p ~/.codex to create it.',
        noteWindows: 'Make sure the config directory exists. API Key Mode stores the key in config.toml; do not commit or share this file. Fully quit and restart the Codex client after changes. Press Win+R to open %userprofile%\\.codex.',
      },
      cliTabs: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your 落雪API Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your 落雪API Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your 落雪API Grok group.',
    ...
    quotaAmount: 'Quota Amount (Points)',
    quotaAmountPlaceholder: 'Enter a Point limit',
    ...
    resetQuotaConfirmMessage: 'Are you sure you want to reset the used quota ({used} Points) for key "{name}" to 0? This action cannot be undone.',
    quotaResetSuccess: 'Quota reset successfully',
    failedToResetQuota: 'Failed to reset quota',
    rateLimitColumn: 'Rate Limit',
    rateLimitSection: 'Rate Limit',
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (Points)',
    rateLimit1d: 'Daily Limit (Points)',
    rateLimit7d: '7-Day Limit (Points)',
  ...
  usage: {
    ...
    averageDurationHint: 'Average response time across all requests',
    ...
    source: 'Source',
    allSources: 'All',
    sourceWebChat: 'GPT Chat',
    sourceApi: 'API',
    requestId: 'Request ID',
    requestIdPlaceholder: 'Enter the full request ID',
    model: 'Model',
    ...
    tabs: { usage: 'Usage', errors: 'Error Requests', ranking: 'User Ranking', billing: 'Chat Billing' },
    errors: {
  ...
  affiliate: {
    ...
    transfer: {
      ...
      success: '{amount} Points have been transferred to your balance'
    },
    invitees: {
      title: 'Invited Users',
  ...
  redeem: {
    title: 'Redeem Code',
    description: 'Enter a code to add balance, increase concurrency, or claim a subscription',
    dividerTitle: 'Redeem Code',
    ...
    balanceRedeemSummary: 'Added {added} Points. Current balance: {balance} Points.',
    ...
    accountRefreshFailed: 'Redeemed successfully, but failed to refresh account information. Refresh the page shortly.',
    ...
    errors: {
      ...
      REDEEM_RATE_LIMITED: 'Too many attempts. Please try again later.',
      REDEEM_CODE_UNSUPPORTED_TYPE: 'This redeem code type is not supported.',
      REDEEM_CODE_INVALID: 'Invalid redeem code. Check the code and try again.'
    }
  },
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      threshold: 'Custom Threshold (Points)',
      thresholdHint: 'Leave empty to use the system default points value',
      thresholdPlaceholder: 'Enter Points',
