export default {
  ...
  nav: {
    ...
    switchToPersonalWorkspace: 'Switch to My Workspace',
    ...
    switchToWork: 'Switch to Work mode',
    ...
    rechargeAndRedeem: 'Top Up / Redeem',
    docs: 'Docs',
    docsTutorial: 'Documentation Guide',
  ...
  accountDock: {
    ...
    summary: 'Balance {balance} · {subscription}',
    ...
    assistance: 'Support',
    help: 'Help',
    personalActions: 'Personal account',
  ...
  auth: {
    ...
    promoCodeValid: 'Valid! You will receive',
