export default {
    ...
    redeem: {
      ...
      form: {
        ...
        balanceHint: 'Balance amount (Snow credits)',
    ...
    promo: {
      ...
      bonusAmount: 'Bonus Snow credits',
      maxUses: 'Max Uses',
    ...
    usage: {
      ...
      description: 'Track requests, reconcile costs, and investigate failures across the platform',
      workspace: {
        tabsLabel: 'Usage analysis views',
        scopeLabel: 'Current analysis scope',
        summaryLabel: 'Current range summary',
        filtersLabel: 'Audit filters',
        evidenceLabel: 'Audit evidence and analysis',
        periodTitle: 'Audit period and granularity',
        auditObjectsTitle: 'Core audit targets',
        conditionsTitle: 'Active conditions',
        noActiveFilters: 'No filters are currently applied',
        ...
        analyticsTitle: 'Data analysis overview',
        analyticsDescription: 'Compare model, group, endpoint, and time trends alongside the request-level evidence.',
        tabs: {
          usageDescription: 'Audit individual requests, tokens, cost, and latency.',
          usageDetail: 'Filter each call by identity, model path, billing evidence, and performance.',
          errorsDescription: 'Locate failures by phase, category, and affected identity.',
          errorsDetail: 'Read-only error audit with copyable request identifiers and raw response evidence.',
          rankingDescription: 'Compare request and usage totals across users in this range.',
          rankingDetail: 'Show the username first when present while retaining email and user ID for verification.',
          billingDescription: 'Audit read-only settlement receipts created by GPT Chat.',
          billingDetail: 'Inspect receipt and request IDs, tokens, charges, balance changes, and failure reasons.',
        },
      },
      userFilter: 'User',
      ...
      billingReceipts: {
        title: 'Chat Billing',
        subtitle: 'Request-level settlement evidence for Web Chat, preserved as an audit trail.',
        readOnly: 'Read-only audit ledger',
        readOnlyDescription: 'Review identifiers and billing facts here. No balances or receipts can be changed from this view.',
        loadFailed: 'Failed to load chat billing receipts',
        empty: 'No chat billing receipts',
        emptyDescription: 'No chat requests match the current date range and filters.',
        viewDetails: 'View read-only details',
        openDetails: 'Open read-only billing audit details for {id}',
        sourceWebChat: 'Web Chat',
        copyReceiptId: 'Copy receipt ID',
        copyRequestId: 'Copy request ID',
        copySuccess: 'Billing identifier copied',
        identifiers: {
          receiptId: 'Receipt ID',
          requestId: 'Request ID',
          sharedId: 'Receipt / Request ID',
          receiptNotGenerated: 'No receipt generated',
        },
        filters: {
          user: 'User',
          ...
          receiptId: 'Receipt ID',
          receiptIdPlaceholder: 'Enter the full receipt or request ID',
          status: 'Status',
        },
        statuses: {
          all: 'All Statuses',
        ...
        drawer: {
          title: 'Chat billing details',
          subtitle: 'Immutable request settlement snapshot',
          readOnlyNote: 'This is an audit-only record. Refund, recalculation, retry, and other billing mutations are not available here.',
          sections: {
            identifiers: 'Audit identifiers',
            models: 'Model routing',
            tokens: 'Token breakdown',
            settlement: 'Settlement math',
