export default {
    accounts: {
      title: 'Account Pool',
      description: 'Manage upstream accounts, scheduling state, and capacity',
      workbench: {
        identity: 'Account',
        quotaCapacity: 'Quota / Capacity',
        quotaUsed: '{percent}% used',
        quotaUnavailable: 'No quota data',
        quotaLabel: 'Quota',
        totalQuotaLabel: 'Total',
        concurrencySummary: 'Concurrency {current} / {max}',
        quotaOverview: 'Quota Overview',
        fiveHourRollingWindow: '5h Rolling Window',
        sevenDayTotalQuota: '7d Total Quota',
        twentyFourHourQuota: '24h Quota',
        dailyQuota: 'Daily Quota',
        totalQuota: 'Total Quota',
        requestQuota: 'Request Quota',
        tokenQuota: 'Token Quota',
        modelQuota: '{model} Quota',
        quotaResetCountdown: 'Resets in {time}',
        quotaResetPending: 'Quota window awaiting refresh',
        quotaResetNow: 'Quota window resets shortly',
        quotaResetsAt: 'Resets {date} · in {time}',
        quotaResetPendingAt: 'Scheduled for {date} · awaiting quota refresh',
        membershipCycle: 'ChatGPT membership',
        workspaceEntitlement: 'Workspace entitlement',
        membershipCurrentPeriodUntil: 'Current period through {date}',
        membershipExpiresAt: 'Expires {date}',
        membershipExpiredAt: 'Expired {date}',
        membershipRefreshNeeded: 'Membership details need refresh',
        membershipLastRecordedUntil: 'Last recorded through {date}',
        membershipUnavailable: 'Membership date unavailable',
        membershipQueryHint: 'Use “Query quota” to sync the membership cycle',
        membershipNotReturned: 'Upstream did not return a valid membership cycle',
        membershipAutoRenewOn: 'Auto-renew is on',
        membershipAutoRenewOff: 'Will not renew after expiry',
        membershipRenewUnknown: 'Renewal status unavailable',
        workspaceEntitlementUntil: 'Entitlement through {date}',
        workspaceEntitlementHint: 'Subject to workspace access and billing settings',
        localConcurrencyCapacity: 'Local Concurrency Capacity',
        concurrencySlots: '{current} / {max} slots',
        activeStatus: 'Active',
        fullStatus: 'At capacity',
        statusScheduling: 'Status & Scheduling',
        effectiveGroups: 'Effective Groups',
        recentActivity: 'Recent Activity',
        scheduling: 'Scheduling',
        groupsAndProxy: 'Groups & Proxy',
        routeAndExit: 'Route & Egress',
        proxyName: 'Proxy',
        proxyEndpoint: 'Endpoint',
        countryCode: 'Country / Region',
        proxyExpiresAt: 'Proxy Expiry',
        fallbackSource: 'Fallback Source',
        exitIp: 'Exit IP',
        proxyRoute: 'Routed through proxy',
        directRoute: 'No proxy configured; using a direct route',
        viewProxyInManagement: 'View proxy {name} in IP Management',
        proxyStatus: {
          active: 'Active',
          inactive: 'Inactive',
          expired: 'Expired'
        ...
        notes: 'Notes',
        accountExpiresAt: 'Account Expiry',
        priority: 'Scheduling Priority',
        billingRate: 'Billing Rate',
        fiveHourReset: '5-hour Reset',
        sevenDayReset: '7-day Reset',
        dailyReset: 'Daily Quota Reset',
        weeklyReset: 'Weekly Quota Reset',
        sessionWindowEnd: 'Session Window End',
        windowCostPolicy: 'Window Cost / Sticky Reserve',
        sessionPolicy: 'Sessions / Idle Minutes',
        rpmPolicy: 'RPM / Strategy',
        ...
        accountUserCost: 'Account / User Cost',
        recovery: 'Status & Recovery',
        errorReason: 'Error',
        rateLimitReset: 'Rate-limit Recovery',
        overloadUntil: 'Overload Recovery',
        tempUnschedulableUntil: 'Temporary Pause Recovery',
        modelRateLimits: 'Model Rate Limits',
        modelRateLimitCount: '{count} model(s) awaiting recovery',
        closeDetails: 'Close account details',
        viewStats: 'View Stats',
        selectAccount: 'Select an account to inspect quota, usage, recovery, policies, groups, and proxy details.',
        inspectAccount: 'Inspect account {name}',
        selectAccountCheckbox: 'Select account {name}'
      },
      ...
      status: {
        ...
        quotaExceededUntil: 'Quota exhausted; expected recovery at {time}',
        ...
        tempUnschedulableUntil: 'Temporarily unschedulable until {time}',
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by LuoxueAPI, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within LuoxueAPI.',
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. LuoxueAPI cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      openai: {
        ...
        endpointCapabilitiesDesc:
          'Used by account routing. The text endpoint follows the Responses API support setting above; Embeddings independently controls /v1/embeddings. Audio transcriptions only opts this account into the controlled STT resource pool for /v1/audio/transcriptions.',
        ...
        capabilityAudioTranscriptions: 'Audio transcriptions',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another LuoxueAPI instance.',
      ...
      openaiQuotaReset: {
        ...
        resetTooltipNeedQuery: 'Click Reset credits first to load the available count',
      ...
      copilot: {
        open: 'Account assistant',
        title: 'Account assistant',
        pageTitle: 'Account pool assistant',
        pageDescription: 'Hand the account pool to AI: scan, test, and filter expired or unusable accounts, then confirm any delete yourself. You can also paste API keys for this service to add; credentials are not sent to the model.',
        subtitle: 'Talk to the assistant in natural language. It uses your admin session. Add and delete both require your confirmation; credentials stay on this service and are not sent to the model.',
        chatTitle: 'Conversation',
        you: 'You',
        assistant: 'Assistant',
        selectAll: 'Select all',
        selectNone: 'Clear selection',
        welcome: 'Tell me which accounts to scan, test, or filter, or paste API keys / JSON for this service to add. Credentials are not sent to the model. Add and delete both require your confirmation on the right.',
        scan: 'Run full health check',
        test: 'Test and filter',
        deleteSelected: 'Delete selected',
        addSelected: 'Add selected',
        inputPlaceholder: 'Tell me what to scan, or paste an API key / JSON',
        send: 'Send',
        emptyQueue: 'No accounts waiting for review. Ask me to scan or test in the chat first.',
        emptyAddQueue: 'No accounts waiting to be added. Paste an API key or JSON in the chat to see them here.',
        reviewTitle: 'Needs your review',
        tabCleanup: 'To clean up',
        tabAdd: 'To add',
        selectedCount: '{count} selected',
        queuePending: 'Needs review',
        queueImporting: 'Importing',
        queueFailed: 'Failed',
        queueQuarantined: 'Quarantined',
        advancedSettings: 'Advanced settings',
        scanFrequency: 'Automatic check frequency',
        frequencyDaily: 'Daily (recommended)',
        frequencyWeekly: 'Weekly',
        frequencyManual: 'Manual only',
        failurePolicy: 'Invalid account handling',
        policyQuarantine: 'Quarantine automatically (recommended)',
        policyReview: 'Keep for review',
        enableNotifications: 'Enable important in-app alerts',
        enableEmailNotifications: 'Enable email alerts',
        enableWebhookNotifications: 'Enable Webhook alerts',
        webhookUrl: 'Webhook URL',
        webhookUrlPlaceholder: 'https://example.com/hooks/account-health',
        settingsHint: 'Proxy and group suggestions are generated from the platform and available nodes. Fine-grained routing rules can be adjusted in account pool settings.',
        enableRegisterWatcher: 'Watch registration tool output folder',
        registerOutputDir: 'Registration output folder',
        registerOutputDirPlaceholder: '/path/to/grok-register/tokens',
        registerAutoDiscover: 'Prompt when new files are found',
        registerScan: 'Scan registration files',
        registerScanning: 'Scanning…',
        registerLastScan: 'Last scan: {time}',
        registerFound: 'Found {count} new Grok SSO file(s) and added them to the review queue.',
        registerNone: 'No new registration tool SSO files found.',
        registerScanFailed: 'Could not scan the registration output folder. Check the folder setting.',
        retryFailed: 'Retry failed items ({count})',
        confirmTitle: 'Delete accounts',
        confirmMessage: 'This will delete {count} selected account(s). This cannot be undone.',
        confirmAddTitle: 'Add accounts',
        confirmAddMessage: 'This will write {count} selected API key(s) into the account pool. Credentials stay on this service and are not sent to the model.',
        ssoConfirmAddMessage: 'This will convert and import {count} Grok SSO token(s) using the selected proxy and groups. Tokens are never sent to the model.',
        handoffSubmitted: 'Submitted account credentials to add (not sent to the model).',
        ssoDetected: 'Grok SSO tokens detected. Choose a proxy and groups, then select and confirm the import. Tokens are never sent to the model.',
        ssoOptionsTitle: 'Grok SSO import options',
        proxyLabel: 'Proxy node',
        proxyDirect: 'Direct connection (no proxy)',
        groupsLabel: 'Groups (multi-select)',
        groupsEmpty: 'No active Grok groups available',
        addHint: 'Paste a key or JSON and it appears on the right. Nothing is written until you select and confirm. Credentials stay on this service.',
        scanning: 'Scanning the account pool…',
        testing: 'Testing account availability…',
        thinking: 'The assistant is thinking and using tools…',
        deleting: 'Deleting…',
        error: 'The assistant request failed',
        needWorkingKey: 'The assistant needs at least one working OpenAI-compatible API Key account before it can run.',
        noCleanup: 'No accounts need cleanup.',
        deleted: 'Deleted {count} account(s).',
        failed: '{count} account(s) failed to delete.',
        added: 'Added {count} account(s).',
        addFailed: '{count} account(s) failed to add.',
        backToAccounts: 'Back to account pool',
        tools: {
          scan_account_pool: 'Scan account pool',
          test_account_pool: 'Test account pool'
        },
        suggestions: {
          scan: 'Live-check the entire account pool',
          test: 'Test unhealthy accounts and filter unusable ones',
          add: 'Hand API keys to me to add to the pool',
          help: 'What can this assistant do?'
        },
        reasons: {
          auth_failed: 'Auth failed / token unusable',
          expired: 'Expired',
