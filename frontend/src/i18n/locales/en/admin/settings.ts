export default {
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many USD the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: ¥1 = ${credit}',
      ...
      balanceNotify: {
        ...
        thresholdHint: '$ value used when a user has not set a custom threshold',
