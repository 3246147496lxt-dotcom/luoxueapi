export default {
    settings: {
      ...
      transcription: {
        ...
        description: 'Manage the cloud speech-to-text model used by Web Chat. This model only writes a transcript into the composer; it never changes the GPT model selected for replies.',
        ...
        groups: 'Transcription resource groups',
        groupsHint: 'Choose active standard OpenAI groups. Previously selected groups that became unavailable remain visible so you can remove them or disable the feature safely.',
        groupMeta: 'Group #{id} · {accounts} active accounts',
        groupUnavailable: 'This group is inactive. Deselect it or restore the group first.',
        missingGroup: 'Deleted group #{id}',
        removeMissingGroup: 'Deselect to remove this stale setting',
        groupsLoadFailed: 'The resource group list could not be loaded',
        noGroups: 'No eligible standard groups',
        noGroupsHint: 'Create a standard OpenAI group, then add at least one API-key account with the Audio Transcriptions capability enabled.',
        failoverTitle: 'Automatic account failover',
        failoverHint: 'The model is not pinned to one API key. Every schedulable transcription account in the selected groups participates; expired, disabled, or rate-limited accounts are skipped.',
        manageAccounts: 'Manage transcription accounts',
        availableInGroups: 'Available in {count} groups',
        modelUnavailable: 'No upstream route is currently available',
        availabilityPending: 'Availability will be checked on save',
        deploymentDefault: 'Using deployment default',
        catalogUnavailableTitle: 'Upstream models cannot be checked right now',
        catalogUnavailableHint: 'The scheduler is unavailable. You can still disable the feature, but restore an upstream account before enabling or switching models.',
        runtimeUnavailableTitle: 'This server node is not ready for voice transcription',
        runtimeUnavailableHint: 'This node is missing ffprobe or has an insufficient request-body safety limit. You can still disable the feature; repair the node before enabling it again.',
        unavailableTitle: 'The selected model is unavailable',
        unavailableHint: 'Check the resource group, API-key status, Audio Transcriptions capability, and account model mapping, then reload.',
        dailyQuotaTitle: 'Daily voice allowance per user',
        dailyQuotaHint: 'Controls how much recorded audio each user can send for cloud transcription per day. Reaching the limit pauses voice input only; text chat continues. Raising it may increase transcription costs.',
        dailyQuotaLabel: 'Daily allowance',
        dailyQuotaUnit: 'seconds / user / day',
        dailyQuotaEquivalent: 'About {minutes} minutes. The allowance resets daily at 00:00 UTC.',
        dailyQuotaInvalid: 'Enter a whole number from {min} to {max} seconds.',
        safetyLimits: 'Deployment safety limits',
        safetyLimitsHint: 'Upload, concurrency, and timeout limits are locked by server configuration. Changes to the allowance and model above require no restart.',
        maxUpload: 'Upload size',
        maxDuration: 'Recording length',
        globalConcurrency: 'Global concurrency',
        userConcurrency: 'Per-user concurrency',
        userRPM: 'Per-user RPM',
        dailySeconds: 'Daily audio seconds',
        requestTimeout: 'Upstream timeout',
        secondsValue: '{value}s',
        statusReady: 'Ready',
        statusDisabled: 'Disabled',
        statusUnavailable: 'Waiting for upstream',
        statusPending: 'Changes need validation',
        unsaved: 'Voice transcription changes have not been saved',
        saved: 'Settings are synchronized to the database',
        reload: 'Recheck',
        discardConfirm: 'Rechecking will discard unsaved voice transcription changes. Continue?',
        save: 'Save and apply now',
        saveSuccess: 'Voice transcription settings updated; no restart required',
        saveFailed: 'Failed to save voice transcription settings',
      },
      features: {
        channelMonitor: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for LuoxueAPI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for LuoxueAPI end-user login',
      ...
      platformQuota: {
        ...
        monthly:     'Monthly (Snow credits, 30d rolling)',
      ...
      customMenu: {
        ...
        authMode: 'External Page Authentication',
        authModeNone: 'No authentication',
        authModeExchangeCode: 'One-time exchange code',
        authModeHint: 'Exchange-code mode sends a short-lived, single-use code instead of exposing this site’s session token.',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many Snow credits the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = {credit} Snow credits',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on LuoxueAPI orders; the upstream type is sent as EasyPay type.',
      ...
      balanceNotify: {
        ...
        threshold: 'Default Threshold (Snow credits)',
        thresholdHint: 'Snow-credit value used when a user has not set a custom threshold',
