export default {
    settings: {
      ...
      platformQuota: {
        ...
        monthly:     'Monthly (Points, 30d rolling)',
      ...
      payment: {
        ...
        balanceRechargePreview: 'Preview: 1 CNY = {credit} Points',
      ...
      balanceNotify: {
        ...
        threshold: 'Default Threshold (Points)',
        thresholdHint: 'Points value used when a user has not set a custom threshold',
