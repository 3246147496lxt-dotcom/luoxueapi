export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 落雪API end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for 落雪API end-user login',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on 落雪API orders; the upstream type is sent as EasyPay type.',
