export default {
    ...
    users: {
      ...
      platformQuota: {
        ...
        subtitle: 'Configure daily / weekly / monthly $ usage limits for each upstream platform for user {email}',
        columns: {
          platform: 'Platform',
          daily: 'Daily ($)',
          weekly: 'Weekly ($)',
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierHint: '$ charged = channel USD base price × group multiplier; e.g. 5 USD/MTok × 1 = 5 $/MTok',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
      ...
      exclusiveTooltip: {
        ...
        example: 'Use case:',
        exampleContent: 'When the public group multiplier is 1, create an exclusive group with a multiplier of 0.9 and assign it to VIP users for a 10% discount.'
      },
