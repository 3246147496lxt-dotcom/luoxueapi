export default {
    ...
    users: {
      ...
      platformQuota: {
        ...
        subtitle: 'Configure daily / weekly / monthly Snow credit usage limits for each upstream platform for user {email}',
        columns: {
          platform: 'Platform',
          daily: 'Daily (Snow credits)',
          weekly: 'Weekly (Snow credits)',
          monthly: 'Monthly (Snow credits, 30-day rolling)',
          usage: 'Current Usage',
        },
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierHint: 'Snow credits charged = channel USD base price × group multiplier; e.g. 5 USD/MTok × 70 = 350 Snow credits/MTok',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
      ...
      subscription: {
        ...
        dailyLimit: 'Daily Limit (Snow credits)',
        weeklyLimit: 'Weekly Limit (Snow credits)',
        monthlyLimit: 'Monthly Limit (Snow credits)',
