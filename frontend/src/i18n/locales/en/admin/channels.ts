export default {
    ...
    riskControl: {
      ...
      deleteFlaggedHashConfirm: 'Delete risk hash {hash}? This input will no longer match the historical hash block.',
      ...
      clearFlaggedHashesConfirmWithCount: 'Clear all {count} risk input hashes? This does not delete audit records, but removes all historical hash blocks.',
