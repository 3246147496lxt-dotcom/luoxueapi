export default {
    ops: {
      ...
      trafficSectionTitle: 'Traffic Performance',
      trafficSectionDescription: 'Inspect live throughput, concurrency utilization, and queue capacity.',
      trafficSectionStatus: 'Live pipeline',
      incidentsSectionTitle: 'Alerts',
      incidentsSectionDescription: 'Review request and upstream failures in impact order.',
      incidentsSectionStatus: 'Exceptions first',
