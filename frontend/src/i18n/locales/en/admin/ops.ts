export default {
    ops: {
      ...
      sidebar: {
        avatar: 'A',
        admin: 'Administrator',
        balanceSubscription: 'Balance & subscription status',
        adminWorkspace: 'Admin Workspace',
        personalWorkspace: 'Personal Center',
        switchToPersonalWorkspace: 'Switch to Personal Center',
      ...
      trafficRail: {
        ...
        allGroups: 'All Channel Groups',
        coreSignals: 'Core Observability Signals',
        healthScore: 'System Health Score',
        healthBasis: 'Based on SLA and error rate',
        slaAttainment: 'SLA Attainment',
        requestErrorRate: 'Request Error Rate',
        realtimeThroughput: 'Realtime Throughput',
        concurrencyQueue: 'Concurrency / Queue',
        excludedBusinessLimits: '429/529 excluded',
        queueDepth: 'Current queue depth is {count}',
        baseHealth: 'System Base Health'
      },
      workspace: {
        ...
        alerts: 'Alert Events',
        logs: 'System Logs',
        alertsDisabled: 'Alert event display is disabled in monitoring settings.'
      },
      liveSectionTitle: 'Live Traffic',
      liveSectionDescription: 'Keep throughput, concurrency, and queue capacity in one scan path.',
      liveSectionStatus: 'Live pipeline',
      qualitySectionTitle: 'Quality & Exceptions',
      qualitySectionDescription: 'Prioritize error trends, then inspect latency distribution and account switching.',
      qualitySectionStatus: 'Exceptions first',
      modelSectionTitle: 'Model Pipeline',
      modelSectionDescription: 'Inspect OpenAI token processing by model and time window.',
      auditSectionTitle: 'Alerts & Audit',
      auditSectionDescription: 'Review alert events and trace root causes through system logs.',
      auditSectionStatus: 'Continuously recorded',
      resourcesSectionTitle: 'Account and IP Resources',
      resourcesSectionDescription: 'Review account recovery queues, IP quality exceptions, and stale checks in one place.',
      resourcesSectionStatus: 'Resource availability',
      trafficSectionTitle: 'Throughput Trend',
      trafficSectionDescription: 'System success ratio and anomaly trends after excluding business limits.',
      trafficSectionStatus: 'Live pipeline healthy',
      incidentsSectionTitle: 'Alerts',
      incidentsSectionDescription: 'Review request and upstream failures in impact order.',
      incidentsSectionStatus: 'Exceptions First Mode',
      diagnosticsSectionTitle: 'Logs & Diagnostics',
      diagnosticsSectionDescription: 'Trace requests through request details and system logs.',
      diagnosticsSectionOpenRequestDetails: 'Open Request Details',
      resourceHealth: {
        nav: {
          label: 'Account and IP resource views',
          overview: 'Overview',
          accounts: 'Account Pool',
          proxies: 'IP Resources'
        },
        loading: 'Loading resource health data',
        retry: 'Retry',
        accountSource: 'Account data:',
        proxySource: 'IP data:',
        alertSource: 'Alert data:',
        accountLoadFailed: 'Failed to load the account pool snapshot',
        proxyLoadFailed: 'Failed to load IP health data',
        alertLoadFailed: 'Failed to load unresolved alerts',
        ...
        overview: {
          title: 'Resource Work Queue',
          description: 'Start with zero-capacity groups, then IP impact and account recovery.',
          maxItems: 'Up to 5 items'
        },
        composition: {
          eyebrow: 'CAPACITY COMPOSITION',
          title: 'Account Capacity Composition',
          snapshot: 'Snapshot {time}',
          schedulable: 'Base schedulable',
          automatic: 'Auto recovering',
          manual: 'Manual action',
          excluded: 'Disabled / manually unscheduled',
          quotaUnknown: '{count} quota coverage unknown',
          chartLabel: 'Account capacity composition across {total} accounts',
          description: 'The 100% stack is shown only when mutually exclusive states reconcile with the account total.',
          incomplete: 'Classified count {sum} does not match total {total}; independent ratios are shown without normalization.',
          empty: 'No account capacity data in the current scope'
        },
        metrics: {
          schedulableAccounts: 'Base schedulable accounts',
          accountsTotal: '{total} accounts in scope',
          groupCapacity: 'Zero capacity / low redundancy groups',
          groupCapacityLegend: 'Zero capacity / low redundancy',
          proxyHealth: 'Healthy IPs / affected accounts',
          proxyHealthLegend: 'Healthy IPs / active accounts affected',
          severeAlerts: 'Unresolved severe alerts',
          severeAlertsHint: 'Firing P0, P1, critical, or severe',
          dataUnavailable: 'Data unavailable'
        },
        pending: {
          title: 'Unified Work Queue',
          description: 'Strictly ordered by zero capacity, IP account impact, manual recovery, and automatic recovery.',
          zeroCapacityGroup: 'Group has zero capacity',
          zeroCapacityDetail: '{platform} has no base schedulable account in this group',
          proxyImpact: 'IP affects {count} active accounts',
          accountManual: 'Account needs recovery',
          accountAutomatic: 'Account auto recovery',
          proxyAnomaly: 'IP exception',
          proxyStale: 'IP needs retest',
          emptyTitle: 'No resource work pending',
          emptyDescription: 'Account and IP resources are available or scheduled to recover automatically.'
        },
        accounts: {
          title: 'Account Pool Health',
          description: 'Read-only account availability. Use Account Management for status changes.',
          openAll: 'Open Account Management',
          disabled: 'Realtime account availability monitoring is disabled.',
          total: 'Total accounts',
          available: 'Base schedulable',
          automaticRecovery: 'Auto recovery',
          manualRecovery: 'Manual recovery',
          manualTitle: 'Manual Recovery',
          manualDescription: 'Accounts with an error, automatic expiry pause, or known exhausted quota.',
          automaticTitle: 'Automatic Recovery',
          automaticDescription: 'Accounts waiting on rate limits, overload protection, or cooldowns.',
          manualBadge: 'Manual action',
          automaticBadge: 'Auto recovery',
          inspect: 'View details',
          noManualTitle: 'No manual recovery items',
          noManualDescription: 'No accounts currently require manual intervention.',
          noAutomaticTitle: 'No automatic recovery items',
          noAutomaticDescription: 'No accounts are rate-limited, overloaded, or cooling down.',
          groupCountsNotAdditive: 'An account can belong to multiple groups. Group counts must not be added together.',
          capacityTitle: 'Group Capacity Risks',
          capacityDescription: 'Zero-capacity groups are listed before low-redundancy groups.',
          zeroCapacity: 'Zero capacity',
          lowRedundancy: 'Low redundancy',
          zeroCapacityReason: 'No base schedulable account remains in this group',
          lowRedundancyReason: 'Only {count} base schedulable account remains in this group',
          healthyCapacityReason: '{count} base schedulable accounts remain in this group',
          noCapacityRiskTitle: 'No group capacity risks',
          noCapacityRiskDescription: 'Every group has more than the low-redundancy threshold.',
          healthyGroups: 'Healthy groups ({count}), collapsed by default',
          schedulableInGroup: '{count} base schedulable accounts',
          quotaCoverageUnknown: '{count} OAuth or model-level dynamic quotas are not included in the health decision.',
          workspaceTitle: 'Account Pool Workspace',
          workspaceDescription: 'Switch by task, then verify the selected record and its related objects in the preview.',
          capacityValue: '{available} / {total}',
          unavailableReason: 'Account is currently unschedulable',
          recoversAt: '{reason}. Expected to recover automatically at {time}',
          reasons: {
            account_error: 'Account is in an error state',
            expired_auto_paused: 'Account expired and automatic pause is enabled',
            known_quota_exhausted: 'Known API key or Bedrock quota is exhausted',
            rate_limited: 'Rate limit will recover automatically',
            overloaded: 'Upstream overload window will recover automatically',
            temporary_cooldown: 'Temporary cooldown will recover automatically'
          }
        },
        proxies: {
          title: 'IP Resource Health',
          description: 'Inspect proxy exits, connectivity, and AI destination quality checks.',
          globalScope: 'IP resources are global and are not limited by the current platform or group filter.',
          openAll: 'Open IP Management',
          total: 'Total IPs',
          healthy: 'Healthy',
          anomalies: 'Exceptions',
          stale: 'Stale checks',
          anomalyTitle: 'IP Exceptions',
          anomalyDescription: 'Lifecycle and health exceptions classified by the proxy health service.',
          staleTitle: 'Stale Checks',
          staleDescription: 'Connectivity or quality snapshots marked stale by the server policy.',
          noAnomalyTitle: 'No IP exceptions',
          noAnomalyDescription: 'No connectivity or quality issues are currently detected.',
          noStaleTitle: 'No stale checks',
          noStaleDescription: 'Every IP snapshot is current under the server policy.',
          partialData: 'The health cache is unavailable. Lifecycle and account impact remain visible, but probe data is partial.',
          inspect: 'View details',
          retest: 'Retest now',
          retesting: 'Retesting',
          retestSuccess: '{name} retest complete',
          retestFailed: 'IP retest failed',
          retestUnavailable: 'Only active, non-expired proxies can be retested.',
          accountCount: '{count} accounts',
          latency: '{value} ms',
          neverChecked: 'Never checked',
          lastCheckedAt: 'Last quality check: {time}',
          connectivityNeverChecked: 'Connectivity was never checked',
          connectivityLastCheckedAt: 'Last connectivity check: {time}',
          bothChecksStale: 'Connectivity and quality snapshots are stale',
          checksCurrent: 'Connectivity and quality snapshots are current',
          unknownAddress: 'Unknown exit',
          unknownAnomaly: 'Unknown exception',
          healthyResources: 'Healthy IP resources ({count}), collapsed by default',
          workspaceTitle: 'IP Resource Workspace',
          workspaceDescription: 'Each IP appears once in the active task list. Select it to inspect impact and retest.',
          scopeIssues: 'Needs action',
          scopeStale: 'Needs retest',
          scopeHealthy: 'Healthy',
          noHealthyTitle: 'No healthy IPs',
          noHealthyDescription: 'No IP in scope currently passes lifecycle, connectivity, and quality checks.',
          activeAccountCount: 'Affects {count} active accounts',
          healthStatus: {
            healthy: 'Healthy',
            degraded: 'Degraded',
            suspected_restricted: 'Suspected restricted',
          ...
          reasons: {
            ...
            inactive: 'Proxy disabled',
            expiringSoon: 'Proxy expires soon',
            not_checked: 'Proxy has not been checked',
            connectivity_stale: 'Connectivity snapshot is stale',
            connectivity_failed: 'Connectivity check failed',
            quality_stale: 'Quality snapshot is stale',
            all_supported_targets_passed: 'All supported targets passed',
            challenge_detected: 'Challenge page detected',
            supported_target_warning_or_failure: 'A supported target returned a warning or failure',
            quality_unknown: 'Quality state is unknown'
          }
        },
        detail: {
          accountKind: 'Account health detail',
          groupKind: 'Group capacity detail',
          proxyKind: 'IP health detail',
          loading: 'Refreshing IP health detail',
          loadFailed: 'Failed to refresh IP health detail',
          reason: 'Reason',
          detectedAt: 'Detection time',
          countdown: 'Countdown',
          relatedObjects: 'Related objects',
          noCountdown: 'No automatic countdown',
          countdownElapsed: 'Due now',
          countdownDays: '{days}d {hours}h remaining',
          countdownHours: '{hours}h {minutes}m remaining',
          countdownMinutes: '{minutes}m remaining',
          proxyReference: 'IP #{id}',
          none: 'None',
          platformAccounts: '{platform}: {count} accounts, {status}',
          groupAccounts: '{platform}: {count} accounts in the group',
          previewTitle: 'Selected resource details',
          selectPrompt: 'Select a record to verify its reason, detection time, and related objects here.',
          platform: 'Platform',
          resourceCount: 'Resource size',
          blockingReason: 'Blocking reason',
          accountCount: '{count} accounts',
          groupMembershipCount: '{count} related groups',
          openManagement: 'Open management view',
          close: 'Close details',
          coverage: {
            pass: 'quality check passed',
            warn: 'quality check warning',
            fail: 'quality check failed',
            challenge: 'challenge detected',
            unknown: 'quality status unknown',
            uncovered: 'quality check not covered'
          }
        }
      },
      // Dashboard
      ...
      systemLogs: {
        ...
        dropped: 'Dropped',
        failed: 'Failed',
        runtimeConfig: 'Runtime Log Configuration',
        runtimeConfigHint: 'Log level, caller, stacktrace, and sampling changes apply immediately after saving.',
        retentionClarification: 'retention_days is retained for compatibility. Scheduled cleanup is controlled by the data-retention policy, not by live log-level changes.',
        all: 'All',
        level: 'Level',
        ...
        clearAlertContext: 'Clear alert-linked filters',
        cleanCurrentFilters: 'Clean current filters',
        cleanupDangerHint: 'Only logs matching the current filters will be removed after confirmation. This cannot be undone.',
        refreshHealth: 'Refresh health',
        empty: 'No system logs',
        emptyHint: 'Adjust the filters above and search again.',
        time: 'Time',
        message: 'Message',
        ...
        inspectorTitle: 'Log Attributes',
        closeDetails: 'Close log details',
        inspectorHint: 'Select a log to inspect its complete structured context.',
        noSelection: 'Select a log entry from the table on the left',
        noSelectionHint: 'View the complete structured log details and context identifiers',
        investigationFromAlert: 'From alert event',
        contextOnly: 'context only',
        appliedFilters: 'Applied filters',
        frequentFilters: 'Frequent filters',
        relatedIdentifiers: 'Related identifiers',
        requestContext: 'Request context',
        errorDetails: 'Error details',
        rawExtra: 'Raw extra JSON',
        sinkHealth: 'Log sink health',
        healthHealthy: 'Healthy',
        healthWarning: 'Dropping logs',
        healthUnhealthy: 'Degraded',
        healthUnavailable: 'Health data unavailable',
        healthLoaded: 'Available',
        avgWriteDelay: 'Average write delay',
        results: 'Results',
        newestFirstCount: '{count} · newest first',
      ...
      alertEvents: {
        ...
        filterLabel: 'Scope Filters',
        refreshQueue: 'Refresh List',
        emptyHint: 'No records match the current filters',
        disabledTitle: 'Alert event display is disabled',
        disabledHint: 'Re-enable it in Monitoring Settings',
        globalContext: 'Current Scope Evidence (GLOBAL CONTEXT)',
        filterTime: 'Time',
        filterEmail: 'Email',
        loading: 'Loading...',
        loadMore: 'Load more',
        ...
        detail: {
          title: 'Alert Detail',
          emptyTitle: 'Select an alert event from the left to begin investigation',
          emptyHint: 'After selection, the system extracts the trigger window and related dimensions for deeper troubleshooting.',
          emptyTip: 'Tip: related logs inherit platform and time window; request_id is passed only when present.',
          open: 'View alert details: {title}',
          ...
          silenceDuration: 'Ignore Duration',
          ...
          historySectionTitle: 'Historical Events',
          historySectionHint: 'Recent event summary for the same rule and dimensions.',
      ...
      settings: {
        ...
        shortTitle: 'Monitoring Settings',
      ...
      charts: {
        throughputSubtitle: 'Analyzing QPS and Token/TPS changes in the selected time window',
        trendView: 'Trend View',
        distributionView: 'Distribution',
        tokenStatsView: 'Token Stats',
        viewMode: 'Throughput views',
        currentAverage: 'Current Average',
        observedPeak: 'Observed Peak',
        tokenLoad: 'Token Load (TPS)',
        noWindowBaseline: 'No window baseline',
        peakVsWindowAverage: '+{percent}% vs window average',
        windowTokenTotal: '{count} Tokens processed in this window',
        periodLegend: 'Period legend',
        currentPeriod: 'Current Period',
        comparisonPeriod: 'Comparison Period',
        throughputEmptyTitle: 'Throughput trend rendering area',
        viewRequestDetails: 'View Request Details',
        exportData: 'Export Data',
        exportDataHint: 'Export current throughput data',
        viewDetails: 'View Details',
        downloadChartFull: 'Download Chart',
