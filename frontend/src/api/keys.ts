 ...
 * @param serviceTierPreference - Optional server-side OpenAI default tier
...
export async function create(
  ...
  serviceTierPreference?: 'standard' | 'priority'
): Promise<ApiKey> {
  const payload: CreateApiKeyRequest = {
    name,
    service_tier_preference: serviceTierPreference ?? 'standard'
  }
