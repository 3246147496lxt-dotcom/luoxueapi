/**
 * Admin Chinese provider endpoints.
 *
 * Coding-plan quota snapshots and pay-as-you-go balance probes are exposed
 * behind one provider-oriented API so the account UI can add providers
...
const cnProvidersAPI = { queryQuota, queryBalance }
