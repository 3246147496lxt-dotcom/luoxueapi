    ...
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                ...
                >
                  <CreditAmount :value="value.toFixed(2)" icon-size="xs" />
                </button>
                <!-- Instant tooltip -->
          ...
          <template #cell-usage_zhipu="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'zhipu')" />
          </template>
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'usage_zhipu', label: t('admin.users.columns.usageZhipu'), sortable: false },
...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_zhipu', 'usage_deepseek',
