...
export interface CreateSettingsDraftOptions {
  loginAgreementDocuments?: LoginAgreementDocument[];
  dingtalkCorporateEmailLabel?: string;
  dingtalkNameLabel?: string;
  dingtalkDepartmentLabel?: string;
  claudeOAuthSystemPromptBlocks?: string;
}
export function createDefaultLoginAgreementDocuments(): LoginAgreementDocument[] {
  return [
...
export function createSettingsDraft(
  options: CreateSettingsDraftOptions = {},
): SettingsDraft {
  return {
  ...
  login_agreement_documents:
    options.loginAgreementDocuments?.map((document) => ({ ...document })) ??
    createDefaultLoginAgreementDocuments(),
  default_balance: 0,
  ...
  dingtalk_connect_sync_corp_email_attr_name: options.dingtalkCorporateEmailLabel ?? "DingTalk Corporate Email",
  dingtalk_connect_sync_display_name_attr_name: options.dingtalkNameLabel ?? "DingTalk Name",
  dingtalk_connect_sync_dept_attr_name: options.dingtalkDepartmentLabel ?? "DingTalk Department",
  ...
  claude_oauth_system_prompt_blocks:
    options.claudeOAuthSystemPromptBlocks ?? "[]",
