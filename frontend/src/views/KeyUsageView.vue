      ...
      <nav class="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          ...
          <a
            v-if="docUrl"
            :href="docUrl"
            data-testid="key-usage-header-docs-link"
            target="_blank"
          ...
          <div v-if="ringItems.length > 0" :class="ringGridClass">
            ...
            >
              <div class="flex items-center justify-between mb-6">
                ...
                <span v-else class="text-sm font-semibold text-gray-500" aria-hidden="true">$</span>
              </div>
              ...
              >
                <div class="flex items-center gap-3">
                  <div class="w-8 h-8 rounded-lg flex items-center justify-center" :class="row.iconBg">
                    <span v-if="row.credit" class="text-sm font-semibold text-gray-500" aria-hidden="true">$</span>
                    <svg
                      v-else
                      class="w-4 h-4"
                      :class="row.iconColor"
      ...
      <div class="mx-auto flex max-w-6xl flex-col items-center justify-center gap-4 text-center sm:flex-row sm:text-left">
        ...
        <div class="flex items-center gap-4">
          <a
            v-if="docUrl"
            :href="docUrl"
            data-testid="key-usage-footer-docs-link"
            target="_blank"
            rel="noopener noreferrer"
