...
func TestRecordCyberPolicyIfMarked_WithMark(t *testing.T) {
	...
	require.NotPanics(t, func() {
		h.recordCyberPolicyIfMarked(c, nil, nil, nil, "gpt-5", false, cyberSessionBlockWritePlan{}, service.ChannelUsageFields{}, "")
	})
...
func TestRecordCyberPolicyIfMarked_ForwardSuccessSkipsUsageLog(t *testing.T) {
	...
	require.NotPanics(t, func() {
		h.recordCyberPolicyIfMarked(c, nil, nil, nil, "gpt-5", false /* forwardErrored=false */, cyberSessionBlockWritePlan{}, service.ChannelUsageFields{}, "")
	})
	require.True(t, c.GetBool(cyberPolicyRecordedKey))
}
...
// TestRecordCyberPolicyIfMarked_BlockKeyPlumbed verifies the block plan is
...
func TestRecordCyberPolicyIfMarked_BlockKeyPlumbed(t *testing.T) {
	...
	h := &OpenAIGatewayHandler{}
	require.NotPanics(t, func() {
		h.recordCyberPolicyIfMarked(c, nil, nil, nil, "gpt-5", true, cyberSessionBlockWritePlan{keys: []string{"deadbeef"}}, service.ChannelUsageFields{}, "")
	})
}
