...
type GroupHandler struct {
	adminService         GroupAdminUseCases
...
func NewGroupHandler(adminService GroupAdminUseCases, dashboardService *service.DashboardService, groupCapacityService *service.GroupCapacityService) *GroupHandler {
	return &GroupHandler{
...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok zhipu deepseek"`
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		ProfitMinMargin:                 float64ValueOrDefault(req.ProfitMinMargin, 0),
		ProfitSafetyBuffer:              float64ValueOrDefault(req.ProfitSafetyBuffer, 0),
