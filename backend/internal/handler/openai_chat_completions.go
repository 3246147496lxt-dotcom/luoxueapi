...
func (h *OpenAIGatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		var cyberBlockPlanChat cyberSessionBlockWritePlan
		if service.GetOpsCyberPolicy(c) != nil {
			cyberBlockPlanChat = buildCyberSessionBlockWritePlan(apiKey.ID, c, body)
		}
		h.recordCyberPolicyIfMarked(c, apiKey, account, subscription, reqModel, err != nil, cyberBlockPlanChat, channelMapping.ToUsageFields(reqModel, ""), service.HashUsageRequestPayload(body))
