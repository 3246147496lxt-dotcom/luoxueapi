...
func TestNormalizeInboundEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"/api/v1/chat/transcriptions", EndpointAudioTranscriptions},
...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"openai audio transcriptions", EndpointAudioTranscriptions, "/api/v1/chat/transcriptions", service.PlatformOpenAI, EndpointAudioTranscriptions},
