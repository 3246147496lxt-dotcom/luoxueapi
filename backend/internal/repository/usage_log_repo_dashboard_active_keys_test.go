...
func TestFillDashboardActiveAPIKeyWeekStats_UsesOneBoundedDistinctQuery(t *testing.T) {
	...
	require.Contains(t, dashboardActiveAPIKeyWeekStatsQuery, "EXISTS")
	require.Contains(t, dashboardActiveAPIKeyWeekStatsQuery, "ak.id = ul.api_key_id")
	require.Contains(t, dashboardActiveAPIKeyWeekStatsQuery, "ak.purpose = 'user'")
