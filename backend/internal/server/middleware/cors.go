...
func CORS(cfg config.CORSConfig) gin.HandlerFunc {
	...
	allowHeaders := []string{
		...
		"accept", "origin", "Cache-Control", "If-None-Match", "X-Requested-With", "X-API-Key", "X-Admin-UI-Request", "X-User-UI-Request",
	}
	...
	return func(c *gin.Context) {
		...
		if originAllowed {
			...
			c.Writer.Header().Set("Access-Control-Expose-Headers", "Content-Disposition, ETag, Server-Timing")
