...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/health/scan", h.Admin.Account.ScanAccountHealth)
		accounts.POST("/health/cleanup", h.Admin.Account.CleanupAccountHealth)
		accounts.POST("/health/add", h.Admin.Account.AddAccountHealth)
		accounts.POST("/health/assistant", h.Admin.Account.AccountHealthAssistant)
		accounts.GET("/health/settings", h.Admin.Account.GetAccountHealthSettings)
		accounts.PUT("/health/settings", h.Admin.Account.UpdateAccountHealthSettings)
		accounts.GET("/import-watcher/settings", h.Admin.Account.GetImportWatcherSettings)
		accounts.PUT("/import-watcher/settings", h.Admin.Account.UpdateImportWatcherSettings)
		accounts.POST("/import-watcher/scan", h.Admin.Account.ScanImportWatcher)
		accounts.POST("/import-watcher/import", h.Admin.Account.ImportWatcherFile)
