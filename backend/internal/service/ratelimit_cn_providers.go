...
//     （CN provider balance/quota checkers）在余额恢复后 ClearTempUnschedulable。
...
func (s *RateLimitService) applyCNProviderReactive429(
	...
	if s == nil || s.accountRepo == nil || account == nil || !account.IsCNProvider() {
		return false
	}
