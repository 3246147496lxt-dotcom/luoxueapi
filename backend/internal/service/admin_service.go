...
type AdminService interface {
	...
	// codeType is optional - pass empty string to return all balance/concurrency types.
	// Subscription redeem-code history is intentionally excluded from the default view.
