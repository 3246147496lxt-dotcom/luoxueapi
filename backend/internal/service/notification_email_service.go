...
<p>Hello {{recipient_name}},</p>
<p>Your current points balance is <strong>{{current_balance}} points</strong>, below the configured alert threshold of <strong>{{threshold}} points</strong>.</p>
...
<p>{{recipient_name}}，您好：</p>
<p>您当前积分余额为 <strong>{{current_balance}} 积分</strong>，已低于提醒阈值 <strong>{{threshold}} 积分</strong>。</p>
<p>请及时充值以免服务中断。</p>
...
<p>Hello {{recipient_name}},</p>
<p>Your recharge of <strong>{{recharge_amount}} points</strong> has been completed.</p>
<p>Current balance: <strong>{{current_balance}} points</strong></p>
<p>Order ID: {{order_id}}</p>`),
		},
		notificationEmailLocaleChinese: {
...
<p>{{recipient_name}}，您好：</p>
<p>您的积分充值 <strong>{{recharge_amount}} 积分</strong> 已完成。</p>
<p>当前余额：<strong>{{current_balance}} 积分</strong></p>
			<p>订单号：{{order_id}}</p>`),
		},
	},
	NotificationEmailEventAccountQuotaAlert: {
