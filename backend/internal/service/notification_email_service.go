...
<p>Hello {{recipient_name}},</p>
<p>Your current USD balance is <strong>{{current_balance}} USD</strong>, below the configured alert threshold of <strong>{{threshold}} USD</strong>.</p>
...
<p>{{recipient_name}}，您好：</p>
<p>您当前美元余额为 <strong>{{current_balance}} 美元</strong>，已低于提醒阈值 <strong>{{threshold}} 美元</strong>。</p>
<p>请及时充值以免服务中断。</p>
...
<p>Hello {{recipient_name}},</p>
<p>Your recharge of <strong>{{recharge_amount}} USD</strong> has been completed.</p>
<p>Current USD balance: <strong>{{current_balance}} USD</strong></p>
<p>Order ID: {{order_id}}</p>`),
		},
		notificationEmailLocaleChinese: {
...
<p>{{recipient_name}}，您好：</p>
<p>您的美元余额充值 <strong>{{recharge_amount}} 美元</strong> 已完成。</p>
<p>当前余额：<strong>{{current_balance}} 美元</strong></p>
			<p>订单号：{{order_id}}</p>`),
		},
	},
	NotificationEmailEventAccountQuotaAlert: {
