...
<p>Hello {{recipient_name}},</p>
<p>Your current Snow credit balance is <strong>❄ {{current_balance}}</strong>, below the configured alert threshold of <strong>❄ {{threshold}}</strong>.</p>
...
<p>Hello {{recipient_name}},</p>
<p>Your recharge of <strong>❄ {{recharge_amount}}</strong> Snow credits has been completed.</p>
...
<p>{{recipient_name}}，您好：</p>
<p>您的雪花额度充值 <strong>❄ {{recharge_amount}}</strong> 已完成。</p>
