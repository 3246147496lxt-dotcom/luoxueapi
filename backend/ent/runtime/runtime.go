...
func init() {
	...
	// apikeyDescServiceTierPreference is the schema descriptor for service_tier_preference field.
	apikeyDescServiceTierPreference := apikeyFields[6].Descriptor()
	// apikey.DefaultServiceTierPreference holds the default value on creation for the service_tier_preference field.
	apikey.DefaultServiceTierPreference = apikeyDescServiceTierPreference.Default.(string)
	// apikey.ServiceTierPreferenceValidator is a validator for the "service_tier_preference" field. It is called by the builders before save.
	apikey.ServiceTierPreferenceValidator = func() func(string) error {
		validators := apikeyDescServiceTierPreference.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(service_tier_preference string) error {
			for _, fn := range fns {
				if err := fn(service_tier_preference); err != nil {
					return err
				}
			}
			return nil
	...
	groupDescProfitControlEnabled := groupFields[45].Descriptor()
	...
	groupDescProfitMinMargin := groupFields[46].Descriptor()
	...
	groupDescProfitSafetyBuffer := groupFields[47].Descriptor()
