...
const (
	// Label holds the string label denoting the desktopdevicesession type in the database.
	Label = "desktop_device_session"
	...
	EdgeDevice = "device"
	// Table holds the table name of the desktopdevicesession in the database.
	Table = "desktop_device_sessions"
	// DeviceTable is the table that holds the device relation/edge.
	DeviceTable = "desktop_device_sessions"
...
// Columns holds all SQL columns for desktopdevicesession fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the DesktopDeviceSession queries.
