...
// DesktopDevicesOrErr returns the DesktopDevices value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) DesktopDevicesOrErr() ([]*DesktopDevice, error) {
	if e.loadedTypes[13] {
		return e.DesktopDevices, nil
	}
...
func (_m *User) QueryDesktopDiagnostics() *DesktopDiagnosticQuery {
	return NewUserClient(_m.config).QueryDesktopDiagnostics(_m)
}
