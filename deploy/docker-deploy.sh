#!/bin/bash
# =============================================================================
# LuoxueAPI Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for LuoxueAPI:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/3246147496lxt-dotcom/luoxueapi/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  LuoxueAPI Deployment Preparation"
    echo "=========================================="
    echo ""
